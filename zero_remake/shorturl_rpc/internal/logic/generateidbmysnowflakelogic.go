...
func (l *GenerateIDbMySnowflakeLogic) GenerateIDbMySnowflake(in *shortUrl.GenerateShortUrlRequest) (*shortUrl.GenerateShortUrlResponse, error) {
	//做一个流量控制器
	// 防止恶意攻击下数据量崩溃
...
// 这个函数用于定期清理过期的短URL记录
func (l *GenerateIDbMySnowflakeLogic) DeleteWithTime() error {
...
func (l *GenerateIDbMySnowflakeLogic) ReadFormMysql(url string) (*models.Shorturl, error) {
...
func (l *GenerateIDbMySnowflakeLogic) SaveToMysql(shorturl models.Shorturl) error {
